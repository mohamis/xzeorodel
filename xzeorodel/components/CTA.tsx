  ...
  return (
    <Container minH={"86vh"} maxW={"7xl"} centerContent>
      <Stack
        ...
        transform={{ base: "auto", md: "translateY(50%);" }}
      >
        <Stack flex={1} spacing={{ base: 5, md: 5 }}>
          <Tag maxW={"80px"} colorScheme={"red"}>
            Xeozrodel
          </Tag>
          <Heading
            lineHeight={1.1}
          ...
          <HStack spacing={{ base: 4, sm: 6 }}>
            <Image
              ...
              align={"center"}
              w={"15%"}
              src={"/assets/logos/logoipsumbest.svg"}
            />
            <Image
              alt={"We are certified Image"}
              fit={"cover"}
              align={"center"}
              w={"15%"}
              src={"/assets/logos/logoipsum-228.svg"}
            />
          </HStack>
          <Stack
            spacing={{ base: 4, sm: 6 }}
